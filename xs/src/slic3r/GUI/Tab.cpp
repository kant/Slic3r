...
void TabFilament::build()
{
	...
	auto page = add_options_page(_(L("Filament")), "spool.png");
		...
		optgroup = page->new_optgroup(_(L("Temperature ")) +L" (°C)"); // degree sign
	...
	page = add_options_page(_(L("Advanced")), "wrench.png");
        ...
        line = { _(L("Ramming")), "" };
        line.widget = [this](wxWindow* parent){
			auto ramming_dialog_btn = new wxButton(parent, wxID_ANY, _(L("Ramming settings"))+L"…", wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT);
...
void TabPrinter::build()
{
	...
	auto page = add_options_page(_(L("General")), "printer_empty.png");
		...
		line.widget = [this](wxWindow* parent){
			auto btn = new wxButton(parent, wxID_ANY, _(L(" Set "))+L"…", wxDefaultPosition, wxDefaultSize, wxBU_LEFT | wxBU_EXACTFIT);
...
//				btn->SetFont($Slic3r::GUI::small_font);
		...
		auto octoprint_host_browse = [this, optgroup] (wxWindow* parent) {
			auto btn = new wxButton(parent, wxID_ANY, _(L(" Browse "))+L"…", wxDefaultPosition, wxDefaultSize, wxBU_LEFT);
...
wxSizer* Tab::compatible_printers_widget(wxWindow* parent, wxCheckBox** checkbox, wxButton** btn)
{
	...
	*btn = new wxButton(parent, wxID_ANY, _(L(" Set "))+L"…", wxDefaultPosition, wxDefaultSize, wxBU_LEFT | wxBU_EXACTFIT);
