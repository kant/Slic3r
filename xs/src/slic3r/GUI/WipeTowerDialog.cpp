...
: wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize/*,wxPoint(50,50), wxSize(800,350),wxBORDER_RAISED*/)
{
	...
	gsizer_param->Add(new wxStaticText(this, wxID_ANY, wxString(_(L(L"Total rammed volume (mm³):")))), 0, wxALIGN_CENTER_VERTICAL);
...
: wxPanel(parent,wxID_ANY, wxDefaultPosition, wxDefaultSize/*,wxBORDER_RAISED*/)
{
	...
	format_sizer(m_sizer_advanced, m_page_advanced, m_gridsizer_advanced,
		_(L(L"Here you can adjust required purging volume (mm³) for any given pair of tools.")),
	...
	format_sizer(m_sizer_simple, m_page_simple, gridsizer_simple,
		...
		_(L(L"Volume to purge (mm³) when the filament is being")), 50);
